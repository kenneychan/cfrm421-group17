"""
STUDENT 4 -- implement the three methods below.
...
class Student4Model(BaseModel):
    ...
    def train(self) -> None:
        ...
        raise NotImplementedError("Student 4: implement train()")
    ...
    def predict(self) -> int:
        ...
        raise NotImplementedError("Student 4: implement predict()")
